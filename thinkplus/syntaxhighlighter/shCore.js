...
name:''
        ...
        toolbar: {
            ...
            getButtonHtml: function (a, b, c) {
                return '<div><a href="#" class="toolbar_item command_' + b + " " + b + '">' + c + "</a></div>"
            },
            getThinkHtml: function () {
                return '<span>ThinkPaP Code</span>'
            },
            handler: function (a) {
                var b = a.target,
                    c = b.className || "";
    ...
    e.Highlighter.prototype = {
        ...
        getTitleHtml: function (a) {
            return a ? "<div class='lightername'><div><->&nbsp;&nbsp;&nbsp;" + a + " ---(点击展开)</div><span>ThinkPaP Code</span></div>" : ""
        },
        ...
        getHtml: function (a) {
            ...
            return b = '<div id="' + t(this.id) + '" class="' + c.join(" ") + '">' + (this.getParam("toolbar") ? e.toolbar.getHtml(this) : "") +  '<table border="0" cellpadding="0" cellspacing="0"><tbody><tr>' + (gutter ? '<td class="gutter">' + this.getLineNumbersHtml(a) + "</td>" : "") + '<td class="code"><div class="container">' + b + "</div></td></tr></tbody></table></div>"
        },
        getDiv: function (a) {
            if (a === null) a = "";
            this.code = a;
...
var ums = document.scripts;
//js[js.length - 1] 就是当前的js文件的路径
ums = ums[ums.length - 1].src.substring(0, ums[ums.length - 1].src.lastIndexOf("/") + 1);
//输出当前js文件所在的目录
//console.info(js);

var shadd = "../../assets/ThinkPlus/syntaxhighlighter/"


$(document).ready(function () {
    SyntaxHighlighter.autoloader(
            ['js', 'jscript', 'javascript', ums + 'scripts/shBrushJScript.js'],
            ['bash', 'shell', ums + 'scripts/ashBrushBash.js'],
            ['css', ums + 'scripts/ashBrushCss.js'],
            ['xml', 'html', ums + 'scripts/shBrushXml.js'],
            ['sql', ums + 'scripts/shBrushSql.js'],
            ['php', ums + 'scripts/shBrushPhp.js']
        );
    SyntaxHighlighter.all();
})
document.writeln("  <link href=\'" + ums + "styles/shCoreframe.css\' rel=\'stylesheet\' />");
document.writeln("  <link href=\'" + ums + "styles/shCoreDefault.css\' rel=\'stylesheet\' />");