...
for (var i = 0; i < colsys.length; i++) {
    ...
    colorb+= ".bg-"+color_name+",.btn-"+color_name+",.drop-"+color_name+">li:hover,.hover-" + color_name + " li:hover{background-color:"+color_color+"!important}";
