...
//进度条
for (var i = 0; i < progressres.progressresize.length; i++) {
    progressressize += ".progress_"+progressres.progressresize[i]+" .progress-bar{height:"+progressres.progressresize[i]+"px;line-height:"+progressres.progressresize[i]+"px}";
    progressressize += ".progress.v.progress_"+progressres.progressresize[i]+",.progress.v.progress_"+progressres.progressresize[i]+" .progress-bar{width:"+progressres.progressresize[i]+"px}";
}

for (var i = 0; i < colsys.length; i++) {
    var color_name = colsys[i].name;
    var color_color = colsys[i].color;
    var color_deepcolor = colsys[i].deepcolor;
    var color_lightcolor = colsys[i].lightcolor;
    var color_deeplightcolor = colsys[i].deeplightcolor;
    var color_wcolor = colsys[i].wcolor;
    var color_lwcolor = colsys[i].lwcolor;
    ...
    colord += ".border-" + color_name + ",.btnk-" + color_name + ",.btnl-" + color_name + ",.hr-" + color_name + ",.one-" + color_name + "::before" +"{border-color:" + color_color + "!important}";

    colore += ".border-t-" + color_name + "{border-top-color:" + color_color + "!important}";

    colorf += ".border-r-" + color_name +"{border-right-color:" + color_color + "!important}";

    colorg += ".border-b-" + color_name + "{border-bottom-color:" + color_color + "!important}";

    colorh += ".border-l-" + color_name +"{border-left-color:" + color_color + "!important}";

    colori += ".btn-" + color_name + ":hover{background:" + color_lightcolor + "!important}";

    colorj += ".btnh-v-" + color_name + ":hover {background:" + color_color + "!important;border-color: " + color_color + "!important}";

    colork += ".btnh-l-" + color_name + ":hover{background:" + color_lightcolor + "!important;border-color: " + color_lightcolor + "!important}";

    colorl += ".btnh-d-" + color_name + ":hover{background:" + color_deepcolor + "!important;border-color: " + color_deepcolor + "!important}";

    colorm += ".btnl-" + color_name + ",.btnk-" + color_name + "{color: " + color_lwcolor + "!important}";

    colorn += ".inp-h-" + color_name + ":hover,.inp-h-" + color_name + ":hover i{border-color:" + color_color + "; background-color:" + color_deeplightcolor + ";color:" + color_color + "}";

    coloro += ".cka-" + color_name + " span,.ckb-" + color_name + " span{color:" + color_color + "}"+
    ...
    colorp += ".th-" + color_name + " th,.td-" + color_name + " td,.th-" + color_name + " .th::before,.td-" + color_name + " .td::before,.onepx-" + color_name + "::before{border-color:" + color_color + "!important}";

    colorq += ".td-" + color_name + "{border-bottom-color:" + color_color + "!important}";

    //隔行换色，滑过变色，行色----深色系列

    colorr +=  ".th-" + color_name + " th,.th-" + color_name + " .th" +
              //".striped-" + color_name + " tr:nth-child(even),.striped-" + color_name + " .tr:nth-child(even)," +
    ...
    colors += ".stripedl-" + color_name + " tr:nth-child(even),.stripedl-" + color_name + " .tr:nth-child(even)"+
              "{background:" + color_deeplightcolor + "!important}";

    colors += ".hoverl-" + color_name + " tbody tr:hover td,.hoverl-" + color_name + " .tbody .tr:hover .td" +
              ",tr.bgl-" + color_name + " td,.tr.bgl-" + color_name + " .td" +
              "{background:" + color_deeplightcolor + "!important;color:" + color_lwcolor + "!important}";

    colors += ".hoverl-" + color_name + " tbody tr:hover a.a,.hoverl-" + color_name + " .tbody .tr:hover a.a" +
              ",tr.bgl-" + color_name + " td a.a,.tr.bgl-" + color_name + " .td a.a" +
   ...
   // tablecolor += ".hoverl-" + color_name + " tbody tr:hover td,.hoverl-" + color_name + " .tbody .tr:hover .td{border-color:" + color_color + "!important}";
    colorw += ".page-" + color_name + " li.curr a{background-color:" + color_color + "!important;border-color:" + color_color + "!important}";
...
for (var i = 0; i < colsys.length; i++) {
    ...
    colorz += ".tooltip-" + color_name + "+.tooltip.top .tooltip-arrow{border-top-color:" + color_color + "!important}";
    colorz += ".tooltip-" + color_name + "+.tooltip.right .tooltip-arrow{border-right-color:" + color_color + "!important}";
    colorz += ".tooltip-" + color_name + "+.tooltip.bottom .tooltip-arrow{border-bottom-color:" + color_color + "!important}";
    colorz += ".tooltip-" + color_name + "+.tooltip.left .tooltip-arrow{border-left-color:" + color_color + "!important}";
